...
class NotebookTest(unittest.TestCase, TaskSet):
    ...
    def test_notebook(self):
        ...
        driver.find_element_by_id("username").send_keys("GGteam")
        ...
        logger.warning("点击打开项目按钮")
        driver.get("https://momodel.cn/workspace/5d9aced17ebafe97a7cc0fb9/app")
        time.sleep(5)
        ...
        time.sleep(5)
        driver.find_element_by_css_selector(
            "* > div.p-Widget.jp-Toolbar.jp-NotebookPanel-toolbar > div:nth-child(5) > button").click()
        time.sleep(5)
        driver.find_element_by_css_selector(
            "* > div.p-Widget.jp-Toolbar.jp-NotebookPanel-toolbar > div:nth-child(4) > button").click()
        # time.sleep(10)
        # driver.find_element_by_css_selector(
